...
const TheStageForum = ({ pageName = "The Stage Forum" }) => {
  ...
  return (
    <main className="min-h-screen bg-[#f5f1e8] text-black">
      ...
      <section
        className="relative flex min-h-screen w-full flex-col items-start overflow-hidden px-12 pb-20 pt-12 sm:px-20 sm:pt-14 md:px-24 md:pt-16 lg:px-28 lg:pt-20"
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1100px]">
          <h2 className="text-4xl uppercase leading-[0.95] sm:text-5xl md:text-6xl lg:text-6xl">
            <span className="block text-[#AA2525]">Inaugural Ceremony</span>
            <span className="block">{pageName}</span>
            <span className="block">@ St Albert&apos;s College</span>
            <span className="block">In Association With</span>
            <span className="block">The English Association</span>
          </h2>
        ...
        <div className="relative z-10 mt-10 grid w-full grid-cols-2 items-start gap-3 lg:absolute lg:top-[10%] lg:right-[9%] lg:mt-0 lg:w-[40%]">
          <div className="space-y-6">
            <figure>
              <img
                alt="Dr Arun Zachariah"
                className="aspect-[4/3] w-full object-cover object-center"
                src="/Dr%20Arun.PNG"
              />
              <figcaption className="mt-3 text-center text-lg sm:text-2xl">
                Dr Arun Zachariah
              </figcaption>
            </figure>
